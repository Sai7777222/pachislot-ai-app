"""Phase 4Q: o_proj低rank対照実験 (o8/o4) 本評価。

A=Base / B=v4 (o_proj r16/alpha16) / C=o8 (o_proj r8/alpha8) / D=o4 (o_proj r4/alpha4)
の4条件で、Phase4Pと同一のQ3/P01/P02/P04/Q9/Q11/E36/persona/structured17/character39を
評価する。generation設定はPhase4O/4Pと完全一致 (max_new_tokens=300, temperature=0.3,
top_p=0.9, 5seed=42-46)。
...
ADAPTER_NAME_FOR_CONDITION = {"B_v4": "v4", "C_o8": "o8", "D_o4": "o4"}
...
def main() -> int:
    print("Loading base model + v4/o8/o4 adapters...")
    ...
    for cond in CONDITIONS:
        ...
        q3_messages_text = q3["question"]
        results["q3_greedy"][cond] = q3_fact_check(
            run_single(
                model, tokenizer, system_prompt, q3["rag_context_text"], q3_messages_text,
    ...
    out_path = EVAL_DIR / "phase4q_comprehensive_results.json"
