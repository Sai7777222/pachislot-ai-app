...
AFFECTED_IDS = ["FX-K01", "FV-P13", "CB-FU-D01", "FX-CB01", "QS-D01", "QS-FU-F-Q1", "QS-FU-F-Q3", "QS-FU-F-Q4"]
AFFECTED_A1_IDS = ["FX-K01"]
...
def main():
    ...
    for pid in AFFECTED_IDS:
        ...
        if pid in AFFECTED_A1_IDS:
            t0 = time.time()
            text1 = generate(model, tokenizer, production_prompt, p["prompt"], context=p["A1"], seed=42)
            results[pid]["A1"] = {**analyze(text1), "latency_sec": round(time.time() - t0, 2)}
